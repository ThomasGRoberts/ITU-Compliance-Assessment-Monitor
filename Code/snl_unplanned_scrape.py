...
Inputs:         n/a
Outputs:        ../Data/SNL Downloads/[YYYYMMDD]/snl_unplanned_[YYYYMMDD].csv
"""
...
with open('../Data/SNL Downloads/' + assessmentdate + '/snl_unplanned_' + assessmentdate + '.csv', 'w') as csvfile:
