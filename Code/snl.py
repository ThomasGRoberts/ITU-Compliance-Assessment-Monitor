...
Input:			n/a
Output:			../Data/SNL Archives/[YYYYMMDD]/networks_[YYYYMMDD].csv	
"""
...
df_licenses.to_csv('../Data/SNL Archives/' + datetime.today().strftime('%Y%m%d') + '/networks_' + datetime.today().strftime('%Y%m%d') + '.csv', index = None)
